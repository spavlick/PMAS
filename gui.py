...
import math
import globals
from scriptgeneGUI import generate_netlist
...
global freq
#set variables
freq=StringVar() #switching frequency
mur1=StringVar() #relative permeability
...
Entry(mainframe,width=15,textvariable=freq).grid(column=1,row=1,sticky=(W,E),columnspan=2)
Entry(mainframe,width=15,textvariable=mur1).grid(column=1,row=2,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=nlayer).grid(column=1,row=3,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=h).grid(column=1,row=4,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=s).grid(column=1,row=5,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=w).grid(column=1,row=6,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=m).grid(column=1,row=7,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=nwinding).grid(column=1,row=8,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=wstyle).grid(column=1,row=9,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=lindex).grid(column=1,row=10,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=g).grid(column=1,row=11,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=Ae).grid(column=1,row=12,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=le).grid(column=1,row=13,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=nc).grid(column=1,row=14,sticky=W,columnspan=2)
Entry(mainframe,width=15,textvariable=c).grid(column=1,row=15,sticky=W,columnspan=2)
...
Button(mainframe,text='Generate Netlist',command=generate_netlist).grid(row=18,columnspan=3)


for child in mainframe.winfo_children(): child.grid_configure(padx=5, pady=5)

root.bind('<Return>',generate_netlist)
